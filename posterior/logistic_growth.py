...
class Growth(pl.variables.TruncatedNormal):
    ...
    '''
    def __init__(self, prior, perturbations_additive, **kwargs):
    ...
    def update(self):
        ...
        if self._there_are_perturbations and not self.perturbations_additive:
...
class RegressCoeff(pl.variables.MVN):
    ...
    perturbations_additive : bool
        If True, perturbations are additive. Else, perturbations are multiplicative
    '''
    def __init__(self, growth, self_interactions, interactions,
        pert_mag, perturbations_additive, **kwargs):
