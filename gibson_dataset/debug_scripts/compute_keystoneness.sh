...
TABLE_BASEPATH="../../output/debug/keystoneness/tables"
CLUSTER_BASEPATH="../../output/debug/keystoneness/clusters"
TAXA_BASEPATH="../../output/debug/keystoneness/taxa"
SEP=","
SIMULATION_DT="0.01"
N_DAYS="60"
...
python ../../keystoneness.py \
    --input ../../output/debug/mdsine2/healthy-seed0/mcmc.pkl \
    --study ../../output/debug/mdsine2/healthy-seed0/subjset.pkl \
...
python ../../keystoneness.py \
    --input ../../output/debug/mdsine2/healthy-seed1/mcmc.pkl \
    --study ../../output/debug/mdsine2/healthy-seed1/subjset.pkl \
...
# UC
python ../../keystoneness.py \
    --input ../../output/debug/mdsine2/uc-seed0/mcmc.pkl \
    --study ../../output/debug/mdsine2/uc-seed0/subjset.pkl \
...
python ../../keystoneness.py \
    --input ../../output/debug/mdsine2/uc-seed1/mcmc.pkl \
    --study ../../output/debug/mdsine2/uc-seed1/subjset.pkl \
