...
BASEPATH="../../output/debug/aggregate_plots/"
TOP="10"
...
python ../scripts/plot_otus.py \
    --study ../../output/debug/processed_data/gibson_healthy_agg_taxa.pkl \
    --output-basepath $BASEPATH \
    --top $TOP
python ../scripts/plot_otus.py \
    --study ../../output/debug/processed_data/gibson_uc_agg_taxa.pkl \
    --output-basepath $BASEPATH \
    --top $TOP