...
python figures_analysis/debug/prior_tests/scripts/cv.py \
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg_name', '-cfg', type=str, dest='cfg_name', required=True,
                        help='Configuration name to run (needs to exist as a .py file in prior_tests/scripts/')
