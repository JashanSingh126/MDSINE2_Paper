...
CYCLE_HEALTHY_FIXED_DIR="${MDSINE2_OUTPUT_PATH}/postprocessing/cycles/fixed_clustering_cluster_level/healthy-${SEED_SETTING}"
CYCLE_UC_FIXED_DIR="${MDSINE2_OUTPUT_PATH}/postprocessing/cycles/fixed_clustering_cluster_level/uc-${SEED_SETTING}"

CHAIN_HEALTHY_FIXED_DIR="${MDSINE2_OUTPUT_PATH}/postprocessing/chains/fixed_clustering_cluster_level/healthy-${SEED_SETTING}"
CHAIN_UC_FIXED_DIR="${MDSINE2_OUTPUT_PATH}/postprocessing/chains/fixed_clustering_cluster_level/uc-${SEED_SETTING}"
