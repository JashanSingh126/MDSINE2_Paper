...
Note: This script is meant to be invoked from the figures_analysis directory.
'''
...
if __name__ == '__main__':
    ...
    tree_fname = '../figures_analysis/files/phylogenetic_placement_OTUs/phylogenetic_tree_only_query.nhx'
