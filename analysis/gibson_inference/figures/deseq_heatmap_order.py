...
if __name__ =="__main__":
    ...
    uc_names, uc_dict = get_deseq_info(deseq_loc, "uc_order")
    ...
    uc_df_abundant = make_df(deseq_loc, new_labels, all_dict, "uc_order")

    healthy_df_non_abundant = make_df(deseq_loc, names_not_abundant, all_dict,
        "healthy_order")
    uc_df_non_abundant = make_df(deseq_loc, names_not_abundant, all_dict,
        "uc_order")

    healthy_df_abundant, healthy_df_non_abundant = change_labels(
        healthy_df_abundant, healthy_df_non_abundant)
    uc_df_abundant, uc_df_non_abundant = change_labels(
        uc_df_abundant, uc_df_non_abundant)
