...
def fit_model(Y, U, T, model, n_subjects):
...
def prediction_experiment(Y, U, T, n_subjects):
...
if __name__ == "__main__":
    Y = pkl.load(open("data/gibson/Y_uc.pkl", "rb"))
    U = pkl.load(open("data/gibson/U_uc.pkl", "rb"))
    T = pkl.load(open("data/gibson/T_uc.pkl", "rb"))
